...
[1]: http://wordpress.org/plugins/addfunc-mobile-detect/other_notes/

== Installation ==

1. Upload the entire `addfunc-mobile-detect` directory to the `/wp-content/plugins/` directory of the desktop website (the website doing the redirecting)
