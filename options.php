...
<?php submit_button(); ?>
      <p class="description"><strong>Note:</strong> This version of AddFunc Mobile Detect does not fully support subdomains in the Desktop Website URI field. This field is used to set the cookie for your desktop website, which tells it whether to redirect the mobile device or not. However, you can still use a website that resides on a subdomain. To do this, omit all characters that come before the first period, but leave the period there (example: .your-website.com). Just be aware that this will set the cookie for all subdomains pertaining to the root domain name (so in our example, the cookie would apply to all of these: m.your-website.com, www.your-website.com, other.your-website.com, even-unregistered-subdomains.your-website.com, etc.).</p>
  </form>
      </div> <!-- post-body-content -->
      <!-- sidebar -->
      <div id="postbox-container-1" class="postbox-container">
        <h2>Support Tickets</h2>
        <p>If you need custom support for this plugin (AddFunc Mobile Detect) or any other AddFunc plugin, you can purchase help with a support ticket below. Support tickets are responded to within 48 hours, but we answer them as soon as possible.</p>
