...
function aFmobdtctRedirect() {
  if((get_option('aFmobdtct_redirect')==1)&&(!is_404())){
...
define('aFmobdtct_NICK', 'Mobile Detect');
  class aFmobdtct_class
  {
    ...
    {
      add_options_page(aFmobdtct_NICK.' Plugin Options', aFmobdtct_NICK, 'manage_options', aFmobdtct_ID.'_options', array('aFmobdtct_class', 'options_page'));
    }
